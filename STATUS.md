...
session IDs are in REQUEST_LOG.md R223. These are user-reported values,
not project-specific usage. R222 completion bdc51f9 is verified on live remote main.
