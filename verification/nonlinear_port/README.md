...
passed metadata/interpreter checks, but setup resource events and FFCx artifact/runtime
identity still require admission review. No FEM launch is granted. No production B1/B2
