"""R237 finite caller for one new instrumented Poiseuille allocation.
...
RUN = Path('/tmp/navier-poiseuille-r237-once')
...
INVENTORY = ROOT/'docs/realizability/evidence/r236/checks.json'
